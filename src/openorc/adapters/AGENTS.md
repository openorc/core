...
- Own runtime-native response extraction, normalization, and provider/runtime error classification locally; consume shared `src/openorc/protocol/` validation for formal OpenOrc contracts rather than duplicating formal OpenOrc schemas here.
